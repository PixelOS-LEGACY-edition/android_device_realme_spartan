...
def blob_fixup_nop_bl(
    ...
    **kargs,
    ...
    for line in run_cmd(cmd).splitlines():
        line = line.split(maxsplit=3)

        if len(line) != 4:
            continue

        offset, _, instr, args = line
...
blob_fixups: blob_fixups_user_type = {
    ...
    'odm/lib64/libpwirissoft.so': blob_fixup()
        .call(blob_fixup_nop_bl, True, '_ZN4pxlw18qcomSetDisplayModeEPvii', '_ZN4pxlw15irisSetConfigExEiiPKi@plt'),
    ...
    'vendor/lib64/vendor.qti.hardware.camera.postproc@1.0-service-impl.so': blob_fixup()
        .call(blob_fixup_nop_bl, True, '__cfi_check', '_ZN7android8hardware22configureRpcThreadpoolEmb@plt'),
}  # fmt: skip
