...
blob_fixups: blob_fixups_user_type = {
    ...
    'odm/lib64/libpwirissoft.so': blob_fixup()
        .call(blob_fixup_nop_bl, '_ZN4pxlw18qcomSetDisplayModeEPvii', '_ZN4pxlw15irisSetConfigExEiiPKi@plt'),
    ...
    'vendor/lib64/vendor.qti.hardware.camera.postproc@1.0-service-impl.so': blob_fixup()
        .call(blob_fixup_nop_bl, '__cfi_check', '_ZN7android8hardware22configureRpcThreadpoolEmb@plt'),
}  # fmt: skip
